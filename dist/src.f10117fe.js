...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"src/helpers/Requests.ts":[function(require,module,exports) {
"use strict";
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4
          /*yield*/
          , axios_1.default.get('https://restcountries.com/v2/all')];
...
},{"axios":"node_modules/axios/index.js"}],"src/task1/Task1.ts":[function(require,module,exports) {
"use strict";
...
var Task1 = function Task1() {
  return __awaiter(void 0, void 0, void 0, function () {
    var localStorageSavedData, currentData, nextUpdateDate, countries, possiblyNextUpdateData, oldData, newData, CompareData;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          if (!!localStorageSavedData) return [3
          /*break*/
          , 2];
        ...
        case 2:
          possiblyNextUpdateData = localStorage.getItem('possibleNextUpdateDate');
          console.log(_typeof(possiblyNextUpdateData));
          ...
          if (!(currentData >= possiblyNextUpdateData)) return [3
          /*break*/
          , 4];
          console.log('📝 Now you updating data!');
          oldData = JSON.parse(localStorageSavedData);
          return [4
          /*yield*/
          , Requests_1.CountriesData()];
        ...
        case 3:
          ...
          CompareData = function CompareData(oldest, newest) {
            var changedData = [];
            oldest.forEach(function (old, oldIndex) {
              newest.forEach(function (curr, currIndex) {
